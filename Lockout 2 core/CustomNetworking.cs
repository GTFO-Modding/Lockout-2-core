...
namespace Lockout_2_core
{
    class CustomNetworking
    {
        ...
        {
            NetworkAPI.RegisterEvent<int>("ClientRequestInfo", B1_Exothermic.ClientRequestInfo);
            ...
            NetworkAPI.RegisterEvent<int>("C1ClientRequestInfo", C1_The_Crimson_King.ClientRequestInfo);
            ...
            NetworkAPI.RegisterEvent<int>("C1DisableBSOD", C1_The_Crimson_King.RecieveDisableBSOD);
            NetworkAPI.RegisterEvent<C1_The_Crimson_King.pVerifyCaptcha>("C1VerifyCaptcha", C1_The_Crimson_King.SyncRecieveVerifyCaptcha);
            NetworkAPI.RegisterEvent<int>("C1SyncSmallPickup", C1_The_Crimson_King.SyncOnCollectSmallPickup);
            ...
            NetworkAPI.RegisterEvent<int>("E1SyncHSUState", E1_Old_Friends.OnHSUExitSequence);
            NetworkAPI.RegisterEvent<pReactorInteraction>("OnAttemptInteractReactor", Patch_LG_WardenObjective_Reactor.OnAttemptInteract);
            NetworkAPI.RegisterEvent<int>("E1ClientRequestInfo", E1_Old_Friends.ClientRequestInfo);
